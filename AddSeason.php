<?php
  ...
  $Season="";
    ...
    $strSQL2= mysqli_query($db,"select * from season");


   if($_SERVER["REQUEST_METHOD"] == "POST") {
$Name = $_POST['Name'];

$data = mysqli_query($db,"insert into season(Name) values ('$Name')");
        if($data)
        {
     $error="Season Added Successfully!";
...
<section id="main-content">
	<section class="wrapper">
		...
		<!-- //market-->
		<div class="card-header">Add New Season</div>
      <div class="card-body">
        <form method="POST">
          <h5 style="color: red; text-align: center;"><?php echo $error ?></h5>
          <div class="form-group">
          
            <input class="form-control" name="Name" id="Name" type="Name"  placeholder="Enter New Season">
          </div>
        
         
          <button class="btn btn-primary btn-block" type="submit">Add New Season</button> 
        </form>
       ...
       <?php
              ...
              ?>
                <tr>
                  ...
                  <td><button onclick="window.location.href='DeleteSeason.php?RID=<?php echo $UID; ?>'">Delete</button></td>
                </tr>
                    <?php endwhile; ?> 
