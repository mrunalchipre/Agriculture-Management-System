<?php
  ...
  $Soil="";
    ...
    $strSQL2= mysqli_query($db,"select * from soiltype");


   if($_SERVER["REQUEST_METHOD"] == "POST") {
$Name = $_POST['Name'];

$data = mysqli_query($db,"insert into soiltype(Name) values ('$Name')");
        if($data)
        {
     $error="Soiltype Added Successfully!";
...
<section id="main-content">
	<section class="wrapper">
		...
		<!-- //market-->
		<div class="card-header">Add New Soiltype</div>
      <div class="card-body">
        <form method="POST">
          <h5 style="color: red; text-align: center;"><?php echo $error ?></h5>
          <div class="form-group">
          
            <input class="form-control" name="Name" id="Name" type="Name"  placeholder="Enter New Soiltype">
          </div>
        
         
          <button class="btn btn-primary btn-block" type="submit">Add New Soiltype</button> 
        </form>
      ...
      <table class="table" ui-jq="footable" ui-options='{
       ...
       <?php
              ...
              ?>
                <tr>
                  <td><?php echo $Soil; ?></td>
                  <td><button onclick="window.location.href='DeleteSoil.php?RID=<?php echo $UID; ?>'">Delete</button></td>
                </tr>
                    <?php endwhile; ?> 
