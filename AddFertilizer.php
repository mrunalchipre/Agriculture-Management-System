<?php
  ...
  $Fertilizer="";
    ...
    $strSQL2= mysqli_query($db,"select * from fertilizer");


   if($_SERVER["REQUEST_METHOD"] == "POST") {
$Name = $_POST['Name'];

$data = mysqli_query($db,"insert into fertilizer(Name) values ('$Name')");
        if($data)
        {
     $error="Fertilizer Added Successfully!";
      ...
      <div class="card-body">
        <form method="POST">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="Name" id="Name" type="Name"  placeholder="Enter New Fertilizer">
          </div>
        
         
          <button class="btn btn-primary btn-block" type="submit">Add New Fertilizer</button> 
        </form>
      ...
      <table class="table" ui-jq="footable" ui-options='{
       ...
       <?php
              while ($rows = mysqli_fetch_array($strSQL2,MYSQLI_ASSOC)):
                   ...
                   $UID =$rows["ID"];
                   $Fertilizer=$rows["Name"];
               
             
              ?>
                <tr>
                  <td><?php echo $Fertilizer; ?></td>
                  <td><button onclick="window.location.href='DeleteFertilizer.php?RID=<?php echo $UID; ?>'">Delete</button></td>
                </tr>
                    <?php endwhile; ?> 
