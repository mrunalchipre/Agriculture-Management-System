<?php
  ...
  $District="";
    ...
    $strSQL2= mysqli_query($db,"select * from dist");


   if($_SERVER["REQUEST_METHOD"] == "POST") {
$Name = $_POST['Name'];

$data = mysqli_query($db,"insert into dist(Name) values ('$Name')");
        if($data)
        {
     $error="District Added Successfully!";
      ...
      <div class="card-body">
        <form method="POST">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="Name" id="Name" type="Name"  placeholder="Enter New District">
          </div>
        
         
          <button class="btn btn-primary btn-block" type="submit">Add New District</button> 
        </form>
       ...
       <?php
              ...
              ?>
                <tr>
                  ...
                  <td><button onclick="window.location.href='DeleteDistrict.php?RID=<?php echo $UID; ?>'">Delete</button></td>
                </tr>
                    <?php endwhile; ?> 
