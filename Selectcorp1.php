<?php
   include('db.php');
    ...
    $strSQL2= mysqli_query($db,"select * from corpdetails");
      ...
      <table class="table" ui-jq="footable" ui-options='{
       ...
       <?php
              ...
              ?>
                <tr>
                  <td><?php echo $Corp; ?></td>
                  <td><button onclick="window.location.href='ShowDetails1.php?RID=<?php echo $UID; ?>'">Show</button></td>
                </tr>
                    <?php endwhile; ?> 
